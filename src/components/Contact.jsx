          ...
          >
            ...
            <div className="relative z-10 space-y-8">
              ...
              >
                ...
                <span className="text-[#288EC2] font-bold text-sm uppercase tracking-wider">Professional B2B Services</span>
              </motion.div> */}
              ...
              <motion.h2
                ...
                className="text-4xl font-bold text-gray-900 leading-[0.9]"
              >
                Partner With
                <br />
                Industry Experts
              ...
              >
                Ready to enhance the yachting experience? Let's discuss
                partnership opportunities and explore how our services can
              ...
              >
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <span className="font-medium">
                    Professional consultation & partnership
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-2 h-2 bg-[#288EC2] rounded-full"></div>
                  <span className="font-medium">
                    Brand representation and coordination
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-2 h-2 bg-[#6EBD49] rounded-full"></div>
                  <span className="font-medium">
                    Comprehensive logistics and support services
                  </span>
                </div>
              </motion.div>
          ...
          >
            ...
            >
              ...
              {/* <p className="text-gray-600 mb-8">
                Tell us about your professional needs and let our team create a
                customized B2B partnership proposal for your business.
              </p> */}
            </motion.div>
