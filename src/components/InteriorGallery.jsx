...
const InteriorGallery = () => {
  ...
  const interiors = [
    { image: interiorBedroom, alt: 'Luxury bedroom with ocean view', title: 'Master Bedroom' },
    { image: interiorLounge, alt: 'Modern lounge area', title: 'Main Salon' },
    { image: interiorDining, alt: 'Elegant dining space', title: 'Dining Area' },
    ...
    <section ref={ref} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Experience unparalleled comfort with our meticulously designed yacht interiors
          </motion.p>
        </motion.div>
              ...
              <div className="aspect-square rounded-3xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-white font-semibold text-lg">{interior.title}</p>
                  </div>
                </div>
