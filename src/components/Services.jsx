  ...
  const services = [
    {
      ...
      description: 'Transform your yacht with our bespoke interior design services, creating luxurious spaces that reflect your personal style and vision.',
    ...
    },
    {
      ...
      description: 'Full-scale yacht interior renovation from concept to completion, breathing new life into every space with premium materials and craftsmanship.',
    ...
    },
    {
      ...
      description: 'Bespoke furniture design and manufacturing tailored specifically for your yacht, combining functionality with elegant marine aesthetics.',
    ...
    },
    {
      ...
      description: 'Expert guidance in selecting premium marine-grade materials, fabrics, and finishes that withstand the marine environment while maintaining luxury.',
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <motion.h2 
              ...
              className="text-7xl font-bold text-gray-900 mb-6 leading-[0.9] tracking-tight"
            >
              <span className="block">Curated Excellence</span>
            ...
            >
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                From initial concept sketches to final installation, our comprehensive suite of services 
                ensures your yacht interior transformation exceeds every expectation.
              </p>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                ...
                <h3 className="text-5xl font-bold text-gray-900 leading-tight mb-6">
                  {service.title}
                </h3>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-3 text-gray-700">
                    ...
                    <span className="font-medium">Premium materials & craftsmanship</span>
                  </div>
                  <div className="flex items-center gap-3 text-gray-700">
                    <div className="w-1.5 h-1.5 bg-[#F37E3A] rounded-full"></div>
                    <span className="font-medium">Project management included</span>
                  </div>
                </div>
                <motion.button 
