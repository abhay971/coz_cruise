...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Complete transformation and modernization'
    },
    {
      number: '03',
      title: 'Premium Materials',
      description: 'Only the finest finishes and furnishings'
    },
    {
      number: '04',
      title: 'Design Consultation',
      description: 'Expert interior designers since 2010'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div>
              ...
              >
                We don't just design interiors—we craft extraordinary experiences. Our comprehensive approach 
                combines innovative design philosophy with meticulous attention to detail, ensuring every element 
                reflects your unique vision while exceeding maritime luxury standards.
              </motion.p>
            </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="w-20 h-20 bg-[#288EC2]/10 border-2 border-[#288EC2] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:bg-[#288EC2] group-hover:scale-110">
                  <span className="text-2xl font-bold text-[#288EC2] group-hover:text-white transition-colors duration-300">{feature.number}</span>
                </div>
